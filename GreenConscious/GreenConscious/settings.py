"""
Django settings for GreenConscious project.
...
SECRET_KEY = 'django-insecure-2lvcqb7hs!*1jc0-ax-rg242)^b+$*7+zuev6*au55muned_n7'
...
MIDDLEWARE = [
    ...
    'userhistory.middleware.UserVisitMiddleware',
]
...
WSGI_APPLICATION = 'GreenConscious.wsgi.application'
